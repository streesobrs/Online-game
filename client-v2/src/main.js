...
import { renderAIBattle } from './features/ai-battle/index.js';
import { renderSpectate } from './features/spectate/index.js';
import { renderShop } from './features/shop/index.js';
...
registerRoute('ai-battle', () => renderAIBattle(viewRoot()));
registerRoute('spectate', () => renderSpectate(viewRoot()));
registerRoute('shop', () => renderShop(viewRoot()));
registerRoute('profile', () => renderProfile(viewRoot()));
