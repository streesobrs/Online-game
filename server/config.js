...
module.exports = {
  ...
  match3Rewards: {
    ...
    rogueExpPerScoreDivisor: 800,                   // 肉鸽试炼经验换算除数（整轮累计总分约 80~120 万，换算约 1000~1500 经验/轮；
    // 实测一局 23 层 80.7 万分 → 基础经验 1039。低于标准无尽跑满一轮的 5000，与它「一轮时长更短」的定位相符）
    rogueMaxScorePerMove: 60000,                    // 肉鸽试炼的单步上限（同上规则）
    // 肉鸽可自选「元素种类降到 4 色」「熟练手法 ×1.25（最多叠 6 张，合计 ×3.81）」等祝福，
    // 单步得分比标准无尽高一个量级，故同样放宽到 60000
